...
if ($_GET["order_date"] && $_GET["invoice_no"]) {
	...
	$pdf->Cell(190,10,"VijayCeramics",0,1,"C");
	$pdf->setFont("Arial",null,12);

	$pdf->Cell(50,20,"Date",0,0);
	$pdf->Cell(50,20,": ".$_GET["order_date"],0,1);
	$pdf->Cell(50,0,"Customer Name",0,0);
	$pdf->Cell(50,0,": ".$_GET["cust_name"],0,1);
	...
	$pdf->Cell(180,100,"Signature",0,0,"R");

	$pdf->Output("D","../PDF_INVOICE/PDF_INVOICE_".$_GET["cust_name"]."_".$_GET["invoice_no"].".pdf");
